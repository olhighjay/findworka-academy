    ...
    <body> 
        ...
        <div class="container card">
            ...
            <h1 style="text-align:center; color:crimson">{{$student->firstname}} {{$student->lastname}}</h1>
                ...
                @else
                    <img class="mx-auto img-fluid rounded-circle d-block" style="width:300px; height:300px"  src="/image/profile_pictures/{{$student->profile_picture}}" alt="profile picture"> 
                @endif
                <br>
