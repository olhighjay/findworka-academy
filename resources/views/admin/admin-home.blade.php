...
@section('content')
    ...
    <h3>  You are logged in {{Auth::user()->firstname}}</h3>
        ...
        @else
            <img class="mx-auto img-fluid rounded-circle d-block" style="width:300px; height:300px"  src="image/profile_pictures/{{$admin->profile_picture}}" alt="profile picture"> 
        @endif
        <br>
        <br>
