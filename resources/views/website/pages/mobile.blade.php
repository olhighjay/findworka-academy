...
<style>
    ...
    .heyo-image {
      ...
      background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.3)), url("/storage/images/mad12.jpg");
...
@section('content')
    ...
    <section class="learning_part">
        ...
        <div class="jj">
        <img src="/storage/images/mad3.png" width="430px" style="margin-left:50px" alt="">
        </div>
        <br>
        <br>
        <br>
