...
<style>
    ...
    .heyo-image {
      ...
      background-image: linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.2)), url("/image/images/ui6.jpg");
...
@section('content')
    ...
    <section class="learning_part">
        ...
        <div class="jj">
        <img src="/image/images/ui1.png" width="440px" style="margin-left:50px" alt="">
        </div>
        <br>
        <br>
        <br>
